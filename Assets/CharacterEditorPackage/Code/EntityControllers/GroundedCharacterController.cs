...
//--------------------------------------------------------------------
//점프 타임을 fixedtime으로 사용하여 점프기회를 쿨타임으로 제한하고 있다.
//return "Idle"이라고 if문에서 사용하여 아이들로 되돌리고 있다.
//다른 모션이 필요할때도 마찬가지로 if를 이용하여 조건부로 사용하고 있다.
//
//
//
//
...
//Jumping values
    ...
    //점프 타임을 fixedtime으로 사용하여 시간을 쿨타임으로 제한하고 있다.
